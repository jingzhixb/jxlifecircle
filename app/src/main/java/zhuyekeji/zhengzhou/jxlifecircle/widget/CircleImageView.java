...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (a.hasValue(de.hdodenhof.circleimageview.R.styleable.CircleImageView_civ_circle_background_color)) {
            mCircleBackgroundColor = a.getColor(de.hdodenhof.circleimageview.R.styleable.CircleImageView_civ_circle_background_color,
                    DEFAULT_CIRCLE_BACKGROUND_COLOR);
        } else if (a.hasValue(de.hdodenhof.circleimageview.R.styleable.CircleImageView_civ_fill_color)) {
            mCircleBackgroundColor = a.getColor(de.hdodenhof.circleimageview.R.styleable.CircleImageView_civ_fill_color,
                    DEFAULT_CIRCLE_BACKGROUND_COLOR);
        }
