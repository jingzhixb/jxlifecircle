...
public class UserDaiXiafeiAdapter extends BaseQuickAdapter<UserOrderYOuHuiBean>
{
    private int type;
    public UserDaiXiafeiAdapter(Context context, int layoutResId, List<UserOrderYOuHuiBean> data,int type)
    {
