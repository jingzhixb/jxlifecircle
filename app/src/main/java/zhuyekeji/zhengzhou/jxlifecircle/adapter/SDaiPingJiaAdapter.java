...
public class SDaiPingJiaAdapter extends BaseQuickAdapter<JiFenOrderBean>
{
    public SDaiPingJiaAdapter(Context context, int layoutResId, List<JiFenOrderBean> data)
    {
