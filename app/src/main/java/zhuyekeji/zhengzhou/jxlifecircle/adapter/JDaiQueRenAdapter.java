...
public class JDaiQueRenAdapter extends BaseQuickAdapter<JiFenOrderBean>
{
    public JDaiQueRenAdapter(Context context, int layoutResId, List<JiFenOrderBean> data)
    {
