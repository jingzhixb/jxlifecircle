...
public class JiFenOrderAdapter extends BaseQuickAdapter<JiFenOrderBean>
{
     public JiFenOrderAdapter(Context context, int layoutResId, List<JiFenOrderBean> data)
    {
