...
public class PUserTuiKuanAdapter extends BaseQuickAdapter<JiFenOrderBean>
{
    public PUserTuiKuanAdapter(Context context, int layoutResId, List<JiFenOrderBean> data)
    {
