...
public class PUserDaiJieAdapter extends BaseQuickAdapter<JiFenOrderBean>
{
    public PUserDaiJieAdapter(Context context, int layoutResId, List<JiFenOrderBean> data)
    {
