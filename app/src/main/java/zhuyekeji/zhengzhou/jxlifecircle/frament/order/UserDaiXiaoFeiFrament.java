...
public class UserDaiXiaoFeiFrament extends BaseFragment
{
    ...
    {
        JxApiCallBack.order_youhui(getToken(), 1, 1, getActivity(), callBack);
    }
    ...
    CallBack callBack = new CallBack()
    {
        ...
        public void onSuccess(int what, Response<String> result)
        {
            if (JsonUtile.getCode(result.body()).equals("200"))
            {
                ...
                adapter = new UserDaiXiafeiAdapter(getActivity(), R.layout.shop_daixiaofei_item, beans, 1);
