...
public class ShopDaiXiaoFei2Frament extends BaseFragment
{
    ...
    {
        JxApiCallBack.shopjiudian_order(getToken(),"1","",1,getActivity(),callBack);
    }
            ...
            switch (what)
            {
                case 1:
                    if (JsonUtile.getCode(result.body()).equals("200"))
                    {
                        ...
                        adapter = new ShopJiuDianAdapter(getActivity(), R.layout.item_jiudian_order, beans,1);
