...
public class UserJIuDianDaiRuZhuFrament extends BaseFragment
{
    ...
    {
        JxApiCallBack.order_jiudian(getToken(), 1, 1, getActivity(), callBack);
    }
           ...
           switch (what)
           {
               case 1:
                   if (JsonUtile.getCode(result.body()).equals("200"))
                   {
                       ...
                       adapter = new PUserDaiJieAdapter(getActivity(), R.layout.item_jiudian_order, beans,1);
