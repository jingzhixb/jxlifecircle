...
public class YiRuZhuFrament extends BaseFragment
{
    ...
    {
        JxApiCallBack.shopjiudian_order(getToken(), "2", "", 1, getActivity(), callBack);
    }
            ...
            switch (what)
            {
                case 1:
                    if (JsonUtile.getCode(result.body()).equals("200"))
                    {
                        ...
                        adapter = new ShopJiuDianAdapter(getActivity(), R.layout.item_jiudian_order, beans, 2);
